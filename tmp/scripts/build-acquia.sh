...
#
# $ bash build-acquia.sh [ /fullpath/to/project.make ] [ /fullpath/to/build/project ]
#
...
echo "# Required for user / password authentication on development environments." >> ${BUILD_DEST}/.htaccess
echo "RewriteEngine on" >> ${BUILD_DEST}/.htaccess
echo "RewriteRule .* - [E=REMOTE_USER:%{HTTP:Authorization},L]" >> ${BUILD_DEST}/.htaccess
